...
const Dropdown = () => {
    ...
    const gameHandlers = (id) => isMobile
        ? { onClick: () => setActiveTab(prev => prev === id ? "" : id) }
        : { onMouseEnter: () => setActiveTab(id), onMouseLeave: () => setActiveTab("") };
        ...
        <div className="section-wrapper">
            <div className="game-container">
                ...
                <ul className="game-list">
                    <li className="sh" {...gameHandlers("sh")}>Silent Hill 2</li>
                    <li className="dmc" {...gameHandlers("dmc")}>Devil May Cry 5</li>
                    <li className="mgs" {...gameHandlers("mgs")}>Metal Gear Solid 2</li>
                    <li className="p4" {...gameHandlers("p4")}>Persona 4 Golden</li>
                    <li className="re" {...gameHandlers("re")}>Resident Evil 4</li>
                </ul>
            </div>
